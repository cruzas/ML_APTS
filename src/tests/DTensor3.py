...
def fsdp_main(rank=None, master_addr=None, master_port=None, world_size=None, args=None):
...
if __name__ == '__main__':
    ...
    master_port = '12345'  
    mp.spawn(fsdp_main, args=(master_addr, master_port, world_size, args), nprocs=world_size, join=True)


# the terminal command to check the version of cuda is: nvcc --version