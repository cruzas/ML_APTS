...
def main():
    ...
    # Define optimizers
    optimizer1 = optim.Adam(model_engine1.parameters(), lr=0.001)
    optimizer2 = optim.Adam(model_engine2.parameters(), lr=0.001)
    ...
    for epoch in range(num_epochs):
        ...
        if dist.get_rank() in [0, 1]:
            model_engine1.train()
            for data, target in train_loader1:  # Assuming train_loader1 is your DataLoader for model_engine1
                ...
                output = model_engine1(data)  # Forward pass
        ...
        if dist.get_rank() in [2, 3]:
            model_engine2.train()
            for data, target in train_loader2:  # Assuming train_loader2 is your DataLoader for model_engine2
                ...
                output = model_engine2(data)  # Forward pass
