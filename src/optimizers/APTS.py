        ...
        if skip_preconditioning is False:
            ...
            if self.forced_decreasing_loss:
                ...
                while loss > self.old_loss: 
                    ...
                    if c > 5:
                        print(f'Warning: APTS is not decreasing the loss {loss} > {self.old_loss}')
                        break
            else:
...
class APTS_W2(Optimizer):
    ...
    def __init__(self,
        ...
        super(APTS_W2, self).__init__(params, {})
