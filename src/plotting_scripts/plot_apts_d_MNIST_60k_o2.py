...
# Losses
files_losses = [
    './results_csv/apts_d_mnist_60000_2_o2_loss_metrics.csv',
    './results_csv/apts_d_mnist_60000_4_o2_loss_metrics.csv',
    './results_csv/apts_d_mnist_60000_6_o2_loss_metrics.csv'
]
...
# Accuracies
files_accuracies = [
    './results_csv/apts_d_mnist_60000_2_o2_accuracy_metrics.csv',
    './results_csv/apts_d_mnist_60000_4_o2_accuracy_metrics.csv',
    './results_csv/apts_d_mnist_60000_6_o2_accuracy_metrics.csv'
]
...
plt.xlim([0, 100])
plt.savefig(f'./plots/APTS_D_MNIST_60000_o2.png', bbox_inches='tight', dpi=300)
plt.show()
