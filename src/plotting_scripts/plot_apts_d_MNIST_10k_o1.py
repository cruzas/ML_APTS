...
# Losses
files_losses = [
    './results_csv/apts_d_mnist_005_10000_2_o1_loss_metrics.csv',
    './results_csv/apts_d_mnist_005_10000_4_o1_loss_metrics.csv',
    './results_csv/apts_d_mnist_005_10000_6_o1_loss_metrics.csv'
]
for file in files_losses:
    ...
    N = file.split("_o1_loss_metrics.csv")[0].split("_")[-1]
    avg_losses_per_epoch[N] = epoch_average_losses

# Accuracies
files_accuracies = [
    './results_csv/apts_d_mnist_005_10000_2_o1_accuracy_metrics.csv',
    './results_csv/apts_d_mnist_005_10000_4_o1_accuracy_metrics.csv',
    './results_csv/apts_d_mnist_005_10000_6_o1_accuracy_metrics.csv'
]
for file in files_accuracies:
    ...
    N = file.split("_o1_accuracy_metrics.csv")[0].split("_")[-1]
    avg_accuracies_per_epoch[N] = epoch_average_accuracies

file = "./results_csv/adam_mnist_005_10000_accuracy_metrics.csv"
df = pd.read_csv(file)
avg_accuracies_adam_per_epoch = df['mean']

file = "./results_csv/adam_mnist_005_10000_loss_metrics.csv"
df = pd.read_csv(file)
...
for N, accuracies in avg_accuracies_per_epoch.items():
    ...
    # Add the handle and label for the current N to the custom legend lists
    legend_handles.append(line1)
    legend_labels.append(f'APTS_D(N:{N},O:1)')
...
plt.xlim([0, 100])
plt.savefig(f'./plots/APTS_D_MNIST_005_10000_o1.png', bbox_inches='tight', dpi=300)
plt.show()
