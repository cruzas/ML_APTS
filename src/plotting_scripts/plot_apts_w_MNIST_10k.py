...
files = [
    './results_csv/results_APTS_W_MNIST_10000_2_cleaned.csv',
    './results_csv/results_APTS_W_MNIST_10000_4_cleaned.csv',
    './results_csv/results_APTS_W_MNIST_10000_6_cleaned.csv'
]
...
plt.xlim([0, 100])
plt.savefig(f'./plots/APTS_W_MNIST_10000.png', bbox_inches='tight', dpi=300)
plt.show()
