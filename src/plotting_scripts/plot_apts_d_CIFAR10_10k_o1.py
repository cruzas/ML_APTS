...
# Losses
files_losses = [
    './results_csv/apts_d_cifar10_005_10000_2_o1_loss_metrics.csv',
    './results_csv/apts_d_cifar10_005_10000_4_o1_loss_metrics.csv',
    './results_csv/apts_d_cifar10_005_10000_6_o1_loss_metrics.csv'
]
...
# Accuracies
files_accuracies = [
    './results_csv/apts_d_cifar10_005_10000_2_o1_accuracy_metrics.csv',
    './results_csv/apts_d_cifar10_005_10000_4_o1_accuracy_metrics.csv',
    './results_csv/apts_d_cifar10_005_10000_6_o1_accuracy_metrics.csv'
]
...
plt.xlim([0, 100])
plt.savefig(f'./plots/APTS_D_CIFAR10_005_10000_o1.png', bbox_inches='tight', dpi=300)
plt.show()
