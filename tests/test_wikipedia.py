...
# train_dataloader = Power_DL(tokenized_train_dataset, 
#                  batch_size=32, 
#                  shuffle=True, 
#                  device='cuda', 
#                  precision=torch.get_default_dtype())
                 
# test_dataloader = Power_DL(tokenized_test_dataset,
#                     batch_size=32,
#                     shuffle=False,
#                     device='cuda',
#                     precision=torch.get_default_dtype())
...
model = LanguageModel(vocab_size, d_model, num_heads, d_ff, num_layers, max_seq_len)
