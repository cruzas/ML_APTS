...
class GlobalModel(nn.Module):
    ...
    def forward(self, x):
        ...
        self.out5 = torch.tanh(torch.relu(self.layer5(self.out4)) + torch.sigmoid(2*self.out3))
        return self.out5
...
class GlobalModelTruncated(nn.Module):
    ...
    def forward(self, x, chunk_id):
        ...
        self.sd2_out5.append(torch.tanh(torch.relu(self.layer5(self.sd2_out4[-1])) + torch.sigmoid(2*self.sd2_out3[-1])))
