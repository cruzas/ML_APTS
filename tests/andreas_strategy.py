...
from optimizers import APTS, TR, LocalTR, TRAdam
...
def main(rank=None, master_addr=None, master_port=None, world_size=None):
    ...
    par_optimizer = APTS(model=par_model, criterion=criterion, subdomain_optimizer=subdomain_optimizer, subdomain_optimizer_defaults={'lr': learning_rage},
                         global_optimizer=TR, global_optimizer_defaults=glob_opt_params, lr=learning_rage, max_subdomain_iter=5, dogleg=True, APTS_in_data_sync_strategy=APTS_in_data_sync_strategy, step_strategy=step_strategy)
    ...
    for epoch in range(40):
        ...
        with torch.no_grad():  # TODO: Make this work also with NCCL
            ...
            if dist.get_rank() in par_model.all_final_stages_main_rank:
                ...
                if dist.get_rank() == par_model.all_final_stages_main_rank[0]:
